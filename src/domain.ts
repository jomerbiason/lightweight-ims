...
export interface StoreSession{id:string;openedAt:string;closedAt?:string}
export interface StoreData{store:Store;categories:Category[];products:Product[];transactions:InventoryTransaction[];shoppingList:ShoppingItem[];sessions:StoreSession[];settings:Record<string,unknown>}
