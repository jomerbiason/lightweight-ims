...
const en:Record<string,string>={
 ...
 heroSubtitle:'Digital notebook for your store • offline-first',quickActions:'Quick actions',sell:'Sell',
...
const fil:Record<string,string>={
 ...
 heroSubtitle:'Digital notebook ng iyong tindahan • offline-first',quickActions:'Mabilis na action',sell:'Magbenta',
